...
![](/assets/prometheus-pull-model.png)
...
PromQL 是 Prometheus 设计出来的一种 DSL , 使用起来的感觉向使用 函数. 关于 PromQL 的内容, 可以参考 另一篇博文 [PromQL 指南](https://kuricat.com/articles/promql-guide-guqc2)
