+++
date = "2019-06-14"
title = "Git Large File Storage 初见指南"
slug = "git-large-file-storage-lcgzi"
categories = [ "Tech", "git" ]
tags = [ "git", "git-lfs" ]
katex = false
headline = "Git Large File Storage 快速入门 - 在 Git 中我们的最佳实践是 **不要使用 Git 跟踪大型的二进制文件**, 但是往往可能有一些特殊的需求."
headImgUrl = "https://raw.githubusercontent.com/Kuri-su/KBlog/master/assets/git-large-file-storage.png"
+++
