       ...
       2. 方法2⭐️ , 初等变换法
          ...
          3. 三个初等矩阵, 用于执行基本行操作
             ...
             2. $E_i(c)$ - 倍数矩阵
                1. ...
             3. $E_{ij}(c)$
          4. A可逆, 对可逆任意矩阵, 可以进行任意的初等行变换 都可以变为 E 单位矩阵
             * $E_{12}(-1)\cdot E_{23}(-1)\cdot E_{3}(-\frac{1}{2})\cdot E_{32}(-2)\cdot E_{31}(-1)\cdot E_{21}(-1)\cdot A =E$
             * .
             * Th. $A 可逆$ $\Leftrightarrow A 为若干个初等矩阵之积$
             * 
          5. 初等变换法求逆阵
...
* 矩阵的秩理论⭐️
  ...
  * 性质4
    * 矩阵乘法不升秩
  * 性质5 ⭐️
    * $A_{m*n}*B_{n*s}, 且 AB=0, 则 r(A)+r(B)\le n$
    * Note: 见AB=0, 就用这个性质
      * .
  * 性质6 
    * .
